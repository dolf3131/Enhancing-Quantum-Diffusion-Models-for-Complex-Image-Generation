...
%the logo (the logo on the right)
{
  ...
  \includegraphics[height=0.75\headerheight]{logos/github.png}
}
...
\begin{description}
  \item[Global Information Propagation]
...
\begin{itemize}
  \item \textbf{ANO Measurement}: \textit{Adaptive Non-Local Observable (ANO)} framework \cite{lin2026quantumsuperresolutionadaptivenonlocal}. 
...
\begin{posterbox}[name=refs,column=2,below=measurement,above=bottom]{References}
